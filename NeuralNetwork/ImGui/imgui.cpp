...
void ImGui::Render()
{
	...
	static const char* credits_text = "Credits: Box2D, fann, SOIL, Dear ImGUI, background image(https://www.picswe.com/), bird image(https://airfreshener.club/), green pole(https://www.forbes.pl/)";
